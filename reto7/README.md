# [Instrucciones](https://adventjs.dev/es/challenges/2022/7)
...
<pre>const a1 = ['bici', 'coche', 'bici', 'bici']
...
const gifts = getGiftsToRefill(a1, a2, a3) // ['muñeca', 'pc']</pre>  
Como ves, los almacenes pueden tener el mismo regalo repetido varias veces. Pero, por más existencias que haya en un almacén, si no tenemos en los otros dos, 
